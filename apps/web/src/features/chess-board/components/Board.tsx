...
import type { Square, Color, Piece, PromotionPiece } from '@/shared/types'
import { Game, squareToCoords, coordsToSquare } from '@/shared/types'
import BoardBackground from './BoardBackground'
import SquareHighlight from './SquareHighlight'
import PieceComponent from './PieceComponent'
import PromotionDialog from './PromotionDialog'
import CheckRing from './CheckRing'
import type { LegalMovesForSquare } from '../model/boardTypes'
